...
from src.pattern import AmountSurge, Bollinger, Disparity, High, MFI, Pattern, RelativeStrength, Trending
...
def _build_disparity_base(name: str, threshold: float) -> Pattern:
...
def _build_extra(name: str, kind: str) -> Pattern:
...
def _build_candidate(spec: dict[str, object]) -> Pattern:
    name = str(spec["name"])
