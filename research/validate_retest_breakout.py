...
from metricstudio.patterns import AllStockPattern, Bollinger, High, Trending, MFI, AmountSurge, RetestBreakout
...
def build_validation_table() -> pd.DataFrame:
    ...
    return summarize_vs_benchmark(
        stats,
        "benchmark",
        ["base", "base+amount1.5x", "retest", "retest+breakout_amount1.5x"],
    )
